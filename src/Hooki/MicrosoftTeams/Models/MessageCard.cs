...
public class MessageCard
{
    ...
    [JsonPropertyName("@context")] public string Context { get; set; } = "https://schema.org/extensions";

    [JsonPropertyName("correlationId")] public string CorrelationId { get; set; } = default!;

    [JsonPropertyName("expectedActors")] public List<string> ExpectedActors { get; set; } = default!;

    [JsonPropertyName("originator")] public string Originator { get; set; } = default!;

    [JsonPropertyName("summary")] public string Summary { get; set; } = default!;

    [JsonPropertyName("themeColor")] public string ThemeColor { get; set; } = default!;
