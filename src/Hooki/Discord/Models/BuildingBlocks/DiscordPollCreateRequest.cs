...
/// </summary>
public class DiscordPollCreateRequest
{
    /// <summary>
    /// Only Text is supported in PollMedia for questions
    /// </summary>
    [JsonPropertyName("question")] public required DiscordPollMedia Question { get; set; }
    
    [JsonPropertyName("answers")] public required List<DiscordPollAnswer> Answers { get; set; }
...
/// </summary>
public class DiscordPollMedia
{
    [JsonPropertyName("text")] public required string Text { get; set; }
    
    [JsonPropertyName("emoji")] public DiscordEmoji? Emoji { get; set; }
}
...
public class DiscordPollAnswer
{
    ...
    [JsonPropertyName("poll_media")] public required DiscordPollMedia DiscordPollMedia { get; set; }
}
...
public class DiscordUser
{
    ...
    [JsonPropertyName("avatar_decoration_data")] public DiscordAvatarDecorationData? AvatarDecorationData { get; set; }
}
