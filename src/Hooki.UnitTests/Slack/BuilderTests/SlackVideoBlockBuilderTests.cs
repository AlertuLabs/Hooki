...
public class SlackVideoBlockBuilderTests
    {
        [Fact]
        public void Build_WithAllRequiredProperties_ReturnsValidVideoBlock()
        {
            // Arrange
            var builder = new SlackVideoBlockBuilder()
                .WithAltText("Alt Text")
                .WithDescription(d => d.WithText("Description").WithType(SlackTextObjectType.PlainText))
                .WithThumbnailUrl("https://example.com/thumbnail.jpg")
                .WithVideoUrl("https://example.com/video.mp4");

            // Act
            var result = builder.Build() as SlackVideoBlock;
            ...
            result.Description.Type.Should().Be(SlackTextObjectType.PlainText);
        ...
        public void Build_WithAllProperties_ReturnsValidVideoBlock()
        {
            ...
            var builder = new SlackVideoBlockBuilder()
                ...
                .WithTitle(t => t.WithText("Title").WithType(SlackTextObjectType.PlainText))
        ...
        public void Build_WithMarkdownDescription_ThrowsInvalidOperationException()
        {
            ...
            var builder = new SlackVideoBlockBuilder()
                .WithAltText("Alt Text")
                .WithDescription(d => d.WithText("Description").WithType(SlackTextObjectType.Markdown))
                .WithThumbnailUrl("https://example.com/thumbnail.jpg")
                .WithVideoUrl("https://example.com/video.mp4");
        ...
        public void Build_WithMarkdownTitle_ThrowsInvalidOperationException()
        {
            ...
            var builder = new SlackVideoBlockBuilder()
                .WithAltText("Alt Text")
                .WithDescription(d => d.WithText("Description").WithType(SlackTextObjectType.PlainText))
                .WithTitle(t => t.WithText("Title").WithType(SlackTextObjectType.Markdown))
                .WithThumbnailUrl("https://example.com/thumbnail.jpg")
                .WithVideoUrl("https://example.com/video.mp4");
